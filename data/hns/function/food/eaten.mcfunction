...
execute on passengers if entity @s[tag=hns_food_basket] run data remove entity @s item
execute on passengers if entity @s[tag=hns_food_dish] run data modify entity @s item.components."minecraft:custom_model_data" set value 10121
tag @s add food_dead